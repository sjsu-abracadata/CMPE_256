...
TEMPLATES = [
    {
        ...
        ],  # setting the django template directory
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
CORS_ALLOWED_ORIGINS = ["https://localhost:8080", "https://127.0.0.1:8000"]
CORS_ORIGIN_ALLOW_ALL = True
CORS_ORIGIN_WHITELIST = ["https://localhost:8080", "https://127.0.0.1:8000"]
